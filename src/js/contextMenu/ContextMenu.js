	...
	$(function () {
			...
			switch (key) {
                ...
                case "delete": {
                    ...
                    switch($node.attr('class')){
                        ...
                        case 'EdgeClass':{
                            canvas.deleteEdgeClassById($node.attr('id'));
                            break;
                        }
                        case 'MappingRule':{
                            canvas.deleteMappingRuleById($node.attr('id'));
                            break;
                        }
                        case 'ClassProperty':{
		...
		$.contextMenu({
			...
			build : function ($trigger, e) {
				EditMenu.EdgeClasses.items = InitClassList(false);
                ...
                else if($target.parent().is('.NodeClass') || $target.parent().is('.ClassProperty')) {
