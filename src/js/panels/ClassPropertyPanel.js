define(['jquery',
    ...
    /**@lends ClassPropertyPanel*/
    function($, _, Global, FooterContent, htmlFormBase, htmlFormInput, htmlFormCheckbox) {

        function ClassPropertyPanel(classProperty) {
            var $InputForm = $(_.template(htmlFormInput)({
                id: 'txtPropName',
                label: 'Name',
                disabled: false
            }));
            var $CheckboxForm = $(_.template(htmlFormCheckbox)({
                id: 'chkbxId',
                label: 'Is identifier ?'
            }));

            var $form = $(htmlFormBase);
            $InputForm.find('input').val(classProperty.getName());
            ...
            footerContent.registerOkButtonCallback(function(event) {
                ...
                if (classProperty.getName() !== newName) {
            ...
            var $panel = $.jsPanel({
                ...
                selector: 'body',
                title: 'ClassProperty: ' + classProperty.getName(),
                position: 'top center',
                theme: 'light',
