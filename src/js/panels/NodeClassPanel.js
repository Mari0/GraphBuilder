define(['jquery',
    ...
    /**@lends NodeClassPanel*/ function ($, FooterContent,htmlFormBase, htmlFormInput, htmlFormCheckBox) {
        ...
        function NodeClassPanel(nodeClass){
            ...
            $InputForm.find('input').val(nodeClass.Name);
            ...
            var $panel = $.jsPanel({
                ...
                selector: 'body',
                title:    "ClassProperty: " + nodeClass.Name,
                position: "top center",
                theme:'light',
